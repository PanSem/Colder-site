document.addEventListener("DOMContentLoaded", function(){
  ...
  window.addEventListener("scroll", function(){
    if(document.getElementsByTagName("html")[0].scrollTop >= 70){
      document.getElementsByClassName("fa-arrow-alt-circle-down")[0].style.display = "inline";
    }else if(document.getElementsByTagName("html")[0].scrollTop <= 70){
      document.getElementsByClassName("fa-arrow-alt-circle-down")[0].style.display = "none";
    }
  });
});
